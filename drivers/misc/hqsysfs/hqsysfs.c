...
struct pcba_info pcba[]={
	...
	{PCBA_D2_MP2_CN,"PCBA_D2_MP2_CN"},
	{PCBA_D2_MP2_GLOBAL,"PCBA_D2_MP2_GLOBAL"},
	{PCBA_D2_MP2_IN,"PCBA_D2_MP2_IN"},
	{PCBA_C6A_CN,"PCBA_C6A_CN"},
	{PCBA_C6A_IN,"PCBA_C6A_IN"},
	{PCBA_C6A_GLOBAL,"PCBA_C6A_GLOBAL"},
	{PCBA_E7A_CN,"PCBA_E7A_CN"},
	{PCBA_E7A_IN,"PCBA_E7A_IN"},
	{PCBA_E7A_GLOBAL,"PCBA_E7A_GLOBAL"}
};
#if 0
...
*/
		...
		count = sprintf(buf, "%s:%s %dGB(EMMC) %dGB(DDR)\n",hwinfo_emmc_info->vendor_name,
			hwinfo_emmc_info->emmc_name,hwinfo_emmc_info->emmc_size,hwinfo_emmc_info->ddr_size);
...
static int __init create_sysfs(void)
{
	...
	/* add wifi/bt/fm/gps */
	hq_regiser_hw_info(HWID_WIFI,"MT6631N");
	hq_regiser_hw_info(HWID_BT,"MT6631N");
	hq_regiser_hw_info(HWID_FM,"MT6631N");
	hq_regiser_hw_info(HWID_GPS,"MT6631N");
