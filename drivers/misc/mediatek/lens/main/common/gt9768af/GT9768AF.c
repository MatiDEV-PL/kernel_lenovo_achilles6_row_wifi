 ...
 * 20190724 MT6762 GT_ray.lei for HQ_M10
 *
 */
...
{
	int i4RetValue = 0;
	char puSendCmd[2] = {0x02, 0x01};//PD
	LOG_INF("Start\n");

	if (*g_pAF_Opened == 2) {
		s4AF_WriteReg(300); //20190520 LQ下电撞击ray添加
		msleep(20);
		s4AF_WriteReg(250);
		msleep(20);
		s4AF_WriteReg(200);
		...
		char puSendCmd[2] = {0x04, 0xFA};//250
		msleep(20);
		char puSendCmd[2] = {0x03, 0x00};
		char puSendCmd[2] = {0x04, 0xC8};//200
		msleep(20);
		char puSendCmd[2] = {0x03, 0x00};
		char puSendCmd[2] = {0x04, 0x96};//150
		msleep(20);
	    */
		LOG_INF("apply\n");
