	...
	enum IMGSENSOR_HW_POWER_STATUS pwr_status)
{
	...
	if ((strcmp(curr_sensor_name,"s5k4h7yx_mipi_raw")==0 || strcmp(curr_sensor_name,"s5k4h7yxqtech_mipi_raw")==0) && IMGSENSOR_SENSOR_IDX_SUB == sensor_idx){
	      return IMGSENSOR_RETURN_ERROR;
	}
	...
	if (strcmp(curr_sensor_name,"s5k4h7yx_mipi_raw")==0 || strcmp(curr_sensor_name,"ov13b10_mipi_raw")==0 ||
		strcmp(curr_sensor_name,"s5k4h7yxqtech_mipi_raw")==0 || strcmp(curr_sensor_name,"ov13b10qtech_mipi_raw")==0)
	{
