...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{ REGFLAG_DELAY, 30, {} },
	{ 0x50, 0x02, {0x5A, 0x19} },
	{ 0xA0, 0x03, {0x00, 0x00, 0x34} },
	{ 0x50, 0x02, {0x5A, 0x23} },
	{ 0x90, 0x06, {0x00, 0x00, 0x00, 0x00, 0x2C, 0x01} },
};
...
static void lcm_init(void)
{
	...
	if (ret < 0)
		LCM_LOGI("FT8201----ocp2131----cmd=%0x--i2c write error----\n", cmd);
	else
		LCM_LOGI("FT8201----ocp2131----cmd=%0x--i2c write success----\n", cmd);
	...
	LCM_LOGI("FT8201----BOE----lcm mode = vdo mode ----\n");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	LCM_LOGI("%s,FT8201 backlight: level = %d\n", __func__, level);
...
struct LCM_DRIVER mipi_ft8201_video_1200p_lcm_drv = {
	.name = "mipi_ft8201_video_1200p",
