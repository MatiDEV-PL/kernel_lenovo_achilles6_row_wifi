...
static int start_test_ft8201(void)
{
	...
	fts_ftest->test_item[FT8201_ENTER_FACTORY_MODE].testresult = RESULT_NG ;
        return ret;
    }
   else{
       FTS_TEST_SAVE_ERR("test init pass\n");
	fts_ftest->test_item[FT8201_ENTER_FACTORY_MODE].testresult = RESULT_PASS;
   }
    ...
    if (true == test_item->short_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
	     fts_ftest->test_item[FT8201_SHORT_CIRCUIT_TEST].testresult = RESULT_NG ;
        }
	else{
             fts_ftest->test_item[FT8201_SHORT_CIRCUIT_TEST].testresult = RESULT_PASS ;
	}
    }
    ...
    if (true == test_item->open_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
	    fts_ftest->test_item[FT8201_OPEN_TEST].testresult = RESULT_NG ;
        }
	else{
            fts_ftest->test_item[FT8201_OPEN_TEST].testresult = RESULT_PASS ;
	}
    }
    ...
    if (true == test_item->cb_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
	     fts_ftest->test_item[FT8201_CB_TEST].testresult = RESULT_NG;
        }
	else{
            fts_ftest->test_item[FT8201_CB_TEST].testresult = RESULT_PASS;
	}
    }
    ...
    if (true == test_item->rawdata_test) {
        ...
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
	    fts_ftest->test_item[FT8201_RAWDATA_TEST].testresult = RESULT_NG;
        }
	else{
           fts_ftest->test_item[FT8201_RAWDATA_TEST].testresult = RESULT_PASS;
	}
    }
