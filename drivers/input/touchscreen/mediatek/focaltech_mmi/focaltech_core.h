...
#define FTS_Y_MAX_DISPLAY_DEFAULT           1920
...
ssize_t fts_GESTURE_read(struct file *file, char *buf,size_t len, loff_t *pos);
ssize_t fts_GESTURE_write(struct file *file, const char *buff, size_t len, loff_t *pos);
